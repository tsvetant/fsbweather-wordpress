...
var gradX = function(id, _options) {
    ...
    gradx = {
        ...
        apply_style: function(ele, value) {
            ...
            gradx.gx('#gradx_code').attr({'name':'fsbwether_options[gradx_code]'}).html(css);
        ...
        load_gradx: function(id, sliders) {
            ...
            var html = "<div class='gradx'>\n\
                        ...
                        <select id='gradx_gradient_type' name='fsbwether_options[gradx_gradient_type]' class='gradx_gradient_type'>\n\
                            <option value='linear'>Linear</option>\n\
                            <option value='circle'>Radial - Circle</option>\n\
                            <option value='ellipse'>Radial - Ellipse</option>\n\
                        </select>\n\
                        <select id='gradx_gradient_subtype' name='fsbwether_options[gradx_gradient_subtype]' class='gradx_gradient_type'>\n\
                        ...
                        <select id='gradx_gradient_subtype2' name='fsbwether_options[gradx_gradient_subtype2]' class='gradx_gradient_type gradx_hide'>\n\
                        </select>\n\
